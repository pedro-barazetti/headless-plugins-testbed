...
class BeenVerifiedOptout {
  ...
  async launch() {
    console.log('🚀 Starting VoterRecords Opt-Out process...');
  ...
  async fillOptoutForm(pii: PersonalInfo) {
    ...
    console.log('1️⃣ Navigating to VoterRecords opt-out page...');
    await loadPageAndSolveTurnstile(this.page, 'https://voterrecords.com/voters/');
