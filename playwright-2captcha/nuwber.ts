...
async function clustrmapsOptOut() {
  ...
  try {
    console.log('🚀 Starting Nuwber Opt-Out process...');
    ...
    console.log('📍 Navigating to Nuwber opt-out page...');
    await page.goto('https://nuwber.com/search?name=John%20Doe&city=Los+Angeles&state=CA', { 
